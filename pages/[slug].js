...
const extractImagesFromContent = (content) => {
  ...
  while ((match = imageRegex.exec(content)) !== null) {
    images.push(match[1]); // Push each image URL found in content
  }
  return images;
};
...
const Post = ({ post }) => {
  ...
  const imagess = [featuredImage, ...images];
          ...
          <article className="overflow-y-auto rounded-xl">
            ...
            <div className="bg-[#fafafae6] dark:bg-[#1d1c28] dark:border-[#333146] dark:shadow-lg border px-4 sm:px-5 py-8 border-[#eaeaea]">
              <div className="flex flex-col-reverse justify-between">
                <div className="">
                  <h1 className="text-2xl font-bold mb-2 leading-[1.15]">
                    {title}
                  </h1>
                ...
                <div className="flex gap-2 mb-8">
                  {imagess.map((image, index) => (
                    <div
                      key={index}
                      className="p-2  sm:w-36  sm:h-32 w-24 h-20 cursor-pointer border dark:border-[#333146] rounded-md"
                ...
                <div className="overflow-hidden mb-3 w-full h-[400px]">
                  <Image
...
export async function getStaticProps({ params }) {
  ...
  try {
    ...
    const postWithDetails = {
      ...
      images, // Store extracted images from content
    };
